...
<template>
  <dialog ref="modalRef" class="fixed rounded-xl max-h-[80dvh] lg:max-h-[95dvh] lg:w-[25dvw] text-main-text border-none outline-none text-wrap bg-primary backdrop:bg-black/80 backdrop:backdrop-blur-sm" @click.self="personagemStore.fecharModal" @close="personagemStore.fecharModal">
